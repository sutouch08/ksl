...
<form id="searchForm" method="post" action="<?php echo current_url(); ?>">
	<div class="row">
		...
		<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
			<label>สี</label>
			<input type="text" class="form-control input-sm" name="color" id="color" value="<?php echo $color; ?>" />
		</div>

		<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
			<label>ไซส์</label>
			<input type="text" class="form-control input-sm" name="size" id="size" value="<?php echo $size; ?>" />
		</div>


		<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
			<label>กลุ่ม</label>
			<select class="form-control input-sm" name="group" id="group" onchange="getSearch()">
		...
		<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
			...
			<select class="form-control input-sm" name="sub_group" id="sub-group" onchange="getSearch()">
				<option value="all">ทั้งหมด</option>
		...
		<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
			...
			<select class="form-control input-sm" name="category" id="category" onchange="getSearch()">
				<option value="all">ทั้งหมด</option>
		...
		<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
			<label>ประเภท</label>
			<select class="form-control input-sm" name="kind" id="kind" onchange="getSearch()">
				<option value="all">ทั้งหมด</option>
		...
		<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
			<label>ชนิด</label>
			<select class="form-control input-sm" name="type" id="type" onchange="getSearch()">
				<option value="all">ทั้งหมด</option>
		...
		<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
			<label>ยี่ห้อ</label>
			<select class="form-control input-sm" name="brand" id="brand" onchange="getSearch()">
				<option value="all">ทั้งหมด</option>
		...
		<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
			...
			<select class="form-control input-sm" name="collection" id="collection" onchange="getSearch()">
				<option value="all">ทั้งหมด</option>
		...
		<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
			<label>ปี</label>
			<select class="form-control input-sm" name="year" onchange="getSearch()">
				<option value="all">ทั้งหมด</option>

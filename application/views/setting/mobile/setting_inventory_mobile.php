...
<form id="inventoryForm" class="margin-top-30" method="post" action="<?php echo $this->home; ?>/update_config">
	<div class="row">
		...
		<div class="col-xs-6 padding-top-5">โซนซื้อ-ขาย เริ่มต้น</div>
		<div class="col-xs-6 text-right">
			<input type="text" class="width-100 text-center" id="default-zone" name="DEFAULT_ZONE" value="<?php echo $DEFAULT_ZONE; ?>" required/>
		</div>
		<div class="col-xs-12 padding-top-5">
			<span class="help-block">กรณีไม่ระบุโซนจะใช้โซนนี้เป็นหลัก</span>
		</div>
		<div class="divider"></div>

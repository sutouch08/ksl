...
<div class="row">
	...
	<div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-6 padding-5 hide">
		...
		<select class="form-control input-sm edit" name="is_wms" id="is_wms" disabled></select>
	</div>
	<div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-6 padding-5">
		<label>BillCode</label>
		<input type="text" class="form-control input-sm text-center" value="<?php echo $doc->bill_code; ?>" disabled />
	</div>

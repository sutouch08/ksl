...
<div class="row">
	...
	<div class="col-lg-4-harf col-md-3-harf col-sm-4 col-xs-12 padding-5">
	...
	<div class="col-lg-2 col-md-2-harf col-sm-2-harf col-xs-6 padding-5">
		<label>รหัสโซน</label>
		<input type="text" class="form-control input-sm edit" name="zone_code" id="zone_code" value="<?php echo $doc->zone_code; ?>" disabled />
	</div>
...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 table-responsive">
		<table class="table table-striped table-narrow border-1" style="min-width:1350px;">
			<thead>
				<tr>
				...
				<?php if (!empty($details)) : ?>
					...
					<?php foreach ($details as $rs) : ?>
						...
						<tr style="<?php echo $hilight; ?>">
							...
							<td class="middle"><?php echo $doc->is_pos_api ? $rs->bill_code : $rs->invoice_code; ?></td>
...
<div class="row">
	...
	<?php if ($doc->status == 2) : ?>
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5">
			<span class="red display-block">ยกเลิกโดย : <?php echo $doc->cancel_by; ?> @ <?php echo thai_date($doc->cancel_on, TRUE); ?></span>

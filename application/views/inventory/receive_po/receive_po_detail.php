...
<div class="row">
	...
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 padding-5">
		<p class="pull-right top-p">
			...
			<?php if ($lnwApi) : ?>
				<?php if($doc->status == 1) : ?>
					<button type="button" class="btn btn-xs btn-primary btn-top" onclick="sendToLnwShop(0)"><i class="fa fa-send"></i> ส่งข้อมูลไป LNW SHOP</button>
				<?php endif; ?>
				<?php if($doc->status == 2) : ?>
					<button type="button" class="btn btn-xs btn-danger btn-top" onclick="sendToLnwShop(1)"><i class="fa fa-send"></i> ส่งข้อมูลยกเลิกไป LNW SHOP</button>
				<?php endif; ?>
			<?php endif; ?>
...
<div class="row">
	...
	<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-4 padding-5">
		...
		<div class="input-group width-100">
			<input type="text" class="form-control input-sm text-center" value="<?php echo ($doc->lnw_export == 1) ? 'Success' : (($doc->lnw_export == 3) ? 'Failed' : (($doc->lnw_export == 2) ? 'Partial' : 'No')); ?>" disabled />

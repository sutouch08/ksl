...
<form id="searchForm" method="post" action="<?php echo current_url(); ?>">
	<div class="row">
		...
		<div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-6 padding-5">
			<label>Ref No.</label>
			<input type="text" class="form-control input-sm search-box" name="ref" value="<?php echo $ref; ?>" />
		</div>
		...
		<table class="table table-striped border-1" style="min-width:1000px;">
			<thead>
				<tr class="font-size-11">
					...
					<th class="fix-width-120 middle">Reference No.</th>
					<th class="fix-width-80 middle">Type</th>
					<th class="fix-width-120 middle">Action</th>
					<th class="fix-width-60 middle">Status</th>
					<th class="fix-width-200 middle">API Path</th>
				...
				<?php if (!empty($logs)) : ?>
					...
					<?php foreach ($logs as $rs) : ?>
						<tr class="font-size-11">
							...
							<td class="middle"><?php echo $rs->ref; ?></td>
							<td class="middle"><?php echo $rs->type; ?></td>
							<td class="middle"><?php echo $rs->action; ?></td>
							<td class="middle"><?php echo $rs->status; ?></td>

...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<label>Ref No.</label>
		<input type="text" class="form-control input-sm" value="<?php echo $ref; ?>" disabled />
	</div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<pre style="font-size:11px;"><?php echo json_encode(json_decode($request_json), JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT); ?></pre>
	</div>

	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<label>Response Json</label>
		<pre style="font-size:11px;"><?php echo json_encode(json_decode($response_json), JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT); ?></pre>
	</div>
</div>
